...
// Copy from https://cdn.plyr.io/3.7.3/plyr.css
// MIT License
export const PlyrStyles = css`
  ...
  .plyr--full-ui input[type='range'] {
    ...
    color: var(
      ...
      var(--plyr-color-main, var(--plyr-color-main, #ffffff))
    );
    display: block;
    height: 19px;
    height: calc(
  ...
  .plyr__control--overlaid {
    ...
    background: var(
      --plyr-video-control-background-hover,
      var(--plyr-color-main, var(--plyr-color-main, #555555))
    );
    border: 0;
    border-radius: 100%;
    color: #fff;
