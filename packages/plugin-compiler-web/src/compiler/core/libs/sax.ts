;(function (sax) {
  ...
  function SAXParser(strict, opt): void {
  ...
  function SAXStream(strict, opt): void {
  ...
  function strictFail(parser, message) {
    ...
    if (
      (<any>parser).ignoreStrictError &&
      (<any>parser).ignoreStrictError(message)
    )
      return
    if ((<any>parser).strict) {
